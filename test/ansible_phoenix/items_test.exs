defmodule AnsiblePhoenix.ItemsTest do
  use AnsiblePhoenix.DataCase

  alias AnsiblePhoenix.Items

  describe "items" do
    alias AnsiblePhoenix.Items.Item

    import AnsiblePhoenix.ItemsFixtures
